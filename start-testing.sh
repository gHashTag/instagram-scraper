...
if command -v bun &> /dev/null; then
    ...
    echo "⚠️ Bun не найден, но найден Node.js. Запускаем тестирование с помощью Node.js..."
    ...
    # Подготавливаем тестовую среду с помощью Node.js
    node scripts/prepare-test-env.ts
    ...
    # Генерируем данные с граничными случаями с помощью Node.js
    node scripts/generate-edge-cases.ts
    ...
    # Запускаем тесты с помощью Node.js
    npx vitest run
