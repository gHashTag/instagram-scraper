...
1. ✅ Кнопка "Вернуться к списку" в сцене управления конкурентами не работала. Обработчик вызывался, но не выполнял переход к списку. **ИСПРАВЛЕНО**: Добавлен прямой вызов шага 2 после установки шага через selectStep.
2. ✅ Кнопка "Обновить список" в сцене управления конкурентами не работала. Обработчик вызывался, но список не обновлялся. **ИСПРАВЛЕНО**: Добавлен прямой вызов шага 2 после установки шага через selectStep.
3. ✅ В сцене управления конкурентами отсутствовала функция удаления конкурентов. **ИСПРАВЛЕНО**: Добавлены кнопки удаления для каждого конкурента и обработчики для них.
