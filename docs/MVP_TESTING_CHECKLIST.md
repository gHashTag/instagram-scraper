...
- ❌ Кнопка "Вернуться к списку" не работает
- 🔄 Удаление конкурента
...
1. Кнопка "Вернуться к списку" в сцене управления конкурентами не работает. Обработчик вызывается, но не выполняет переход к списку.
2.
3.
