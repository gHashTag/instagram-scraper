...
import { InstagramScraperService, ScrapedReel, ScraperOptions } from "../types"

/**
 * Mock-реализация сервиса Apify для скрапинга Instagram
 */
export class MockApifyService implements InstagramScraperService {
  private defaultDelay: number = 500 // Задержка по умолчанию (мс)
  private mockReels: Map<string, ScrapedReel[]> = new Map() // Мок-данные для аккаунтов
  private mockHashtags: Map<string, ScrapedReel[]> = new Map() // Мок-данные для хэштегов
