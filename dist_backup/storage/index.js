...
const multitenantFilePath = path.resolve(__dirname, "./neonStorage-multitenant.ts");
...
if (fs.existsSync(multitenantFilePath)) {
    ...
    export { createMultitenantNeonStorageAdapter, createTables, dropTables, testNeonConnection, 
    // Экспортируем функции прямого доступа к Neon
    initializeNeonStorage, closeNeonStorage, createUser, getUserByTelegramId, createProject, getProjectsByUserId, addCompetitorAccount, getCompetitorAccounts, addTrackingHashtag, getTrackingHashtags, saveReels, getReels, getProjectStats, addToFavorites, removeFromFavorites, getFavoriteReels, hideReel, getReelInteraction, getParsingLogs, getAllActiveUsers, logParsingRun, } from "./neonStorage-multitenant";
    // Экспортируем типы из Neon
    export type { InstagramReel, User as NeonUser, Project as NeonProject, CompetitorAccount, TrackingHashtag, ParsingLog, ReelWithSource, } from "./neonStorage-multitenant";
}
